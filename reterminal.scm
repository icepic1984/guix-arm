...
(define-public lis3lv02d-linux-module
  (package
    ...
    (arguments
     (list #:tests? #f #:linux linux-raspberry-5.10))                ; no test suite, RPI Linux
    (home-page "https://github.com/shlyakpavel/seeed-linux-dtoverlays-guix/tree/master/modules/lis3lv02d")
...
(define-public ltr30x-linux-module
  (package
    ...
    (arguments
     (list #:tests? #f #:linux linux-raspberry-5.10))                ; no test suite, RPI Linux
    (home-page "https://github.com/shlyakpavel/seeed-linux-dtoverlays-guix/tree/master/modules/ltr30x")
