...
(define raspberry-pi-barebones-os
  (operating-system
   ...
   (initrd-modules (cons* "fuse" "8021q" "garp" "stp" "llc" "joydev" "snd_soc_hdmi_codec" "rtc_pcf8563" "industrialio_triggered_buffer" "kfifo_buf" "industrialio" "gpio_pca953x" "pinctrl_mcp23s08" "regmap_i2c" "brcmfmac" "brcmutil" "vc4" "cec" "cfg80211" "v3d" "rfkill" "gpu_sched" "dwc2" "drm_kms_helper" "raspberrypi_hwmon" "roles" "bcm2835_v4l2" "bcm2835_codec" "bcm2835_isp" "i2c_brcmstb" "videobuf2_vmalloc" "bcm2835_mmal_vchiq" "v4l2_mem2mem" "videobuf2_dma_contig" "videobuf2_memops" "isp" "em2mem,bcm2835_isp" "i2c_bcm2835" "drm" "uf2_common,v4l2_mem2mem,bcm2835_isp" "drm_panel_orientation_quirks" "snd_bcm2835" "common,v4l2_mem2mem,bcm2835_isp" "vc_sm_cma" "snd_soc_core" "snd_compress" "snd_pcm_dmaengine" "soc_core,snd_pcm_dmaengine" "snd_timer" "mpress,snd_soc_core,snd_pcm" "syscopyarea" "sysfillrect" "rpivid_mem" "sysimgblt" "nvmem_rmem" "fb_sys_fops" "backlight" "uio_pdrv_genirq" "uio" "gpio_keys" "i2c_dev" "aes_neon_bs" "sha256_generic" "aes_neon_blk" "crypto_simd" "cryptd" "ip_tables" "x_tables" "ipv6" %base-initrd-modules))
